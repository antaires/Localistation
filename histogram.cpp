...
// openings_barriers
#define DATAFILE "/Users/valiaodonnell/Documents/School/Bristol/masterProject/histogram/histogram/data/unityOutput/lineOfSight/doorNodoor/4.5/unityData.txt"
...
public:
    ...
    // more sensitive than turnBit2() --> picks up turns of smaller difference in heading
    std::string determineTurnBit3(double prevHeading, double heading){
        double h1 = prevHeading;
        double h2 = heading;
